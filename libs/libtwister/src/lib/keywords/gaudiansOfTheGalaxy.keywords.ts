...
export const Shards: IKeyword = {
  ...SHARDS,
  description: `This set contains 18 "Shard" tokens. These tokens can be gained by players, Villains and Masterminds from the supply. There is no limit to the number of Shards that can be in the game at once.
<ul>
